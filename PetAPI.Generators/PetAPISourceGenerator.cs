    ...
    public class PetAPISourceGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            context.RegisterSourceOutput(interfaceDeclarations, (ctx, interfaceSymbols) =>
            {
                ...
                var dbSetCode = GenerateDbSets(allEntityNames);
                ctx.AddSource("PetAPIContext.g.cs", SourceText.From(dbSetCode, Encoding.UTF8));
            });
        }
        ...
        private string GenerateDbSets(List<string> allEntityNames)
        {
            var code = new StringBuilder();
            code.AppendLine("""
                using Microsoft.EntityFrameworkCore;
            ...
            {
                code.AppendLine($$"""
                        public DbSet<{{name}}> {{name + "s"}} { get; set; } = default!;
